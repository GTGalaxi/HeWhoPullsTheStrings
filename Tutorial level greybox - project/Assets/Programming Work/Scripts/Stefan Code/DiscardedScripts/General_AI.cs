...
[System.Serializable]
public class AnimationSetGeneral
{
...
public class General_AI : MonoBehaviour
{
    ...
    public AnimationSetGeneral AnimationSetGeneral = new AnimationSetGeneral();
    ...
    void Start()
    {
        ...
        AnimationSetGeneral.anim = GetComponent<Animation>();
    ...
    void Patrol()
    {
        ...
        if (Vector3.Distance(this.transform.position, waypoints[waypointInd].transform.position) >= 2)
        {
            ...
            AnimationSetGeneral.anim.clip = AnimationSetGeneral.GeneralWalk;
            ...
            //AnimationSetGeneral.anim.Play("GeneralWalk");

            //  Use this method
            AnimationSetGeneral.anim.CrossFade(AnimationSetGeneral.GeneralWalk.name, 0.2F, PlayMode.StopAll);
    ...
    void Hurt()
    {
        ...
        if (HurtPlayer == false)
        {
            AnimationSetGeneral.anim.clip = AnimationSetGeneral.GeneralHurt;
            AnimationSetGeneral.anim.CrossFade(AnimationSetGeneral.GeneralHurt.name, 0.2F, PlayMode.StopAll);
    ...
    void Investigate()
    {
        ...
        AnimationSetGeneral.anim.clip = AnimationSetGeneral.GeneralInvestigate;
        AnimationSetGeneral.anim.CrossFade(AnimationSetGeneral.GeneralInvestigate.name, 0.2F, PlayMode.StopAll);
    ...
    void OnTriggerEnter(Collider coll)
    {
        if (coll.tag == "Player")
        {
            state = General_AI.State.INVESTIGATE;
